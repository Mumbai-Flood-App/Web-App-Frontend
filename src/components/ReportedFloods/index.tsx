    ...
    <div className="w-full min-h-screen flex items-center justify-center bg-white">
      ...
      >
        ...
        <textarea
          ...
          className="w-full border border-gray-600 rounded-lg px-3 py-2 text-base bg-gray-900/90 text-white placeholder-gray-400 mb-2 focus:outline-none focus:border-blue-500 transition-colors shadow-sm resize-y min-h-[44px]"
        ></textarea>
